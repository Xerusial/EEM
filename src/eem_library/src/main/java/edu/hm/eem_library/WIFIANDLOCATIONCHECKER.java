...
public final class WIFIANDLOCATIONCHECKER {
    ...
    public static final int WIFI_OR_LOCATION_REQUEST = 1;
...
// This is Deprecated in API 28
    ...
    private static <T extends AppCompatActivity> void showWifiOrLocationDialog(@NonNull final T apl, @Nullable WifiManager wm, @Nullable LocationManager lm){
        ...
        builder.setPositiveButton(apl.getString(R.string.ok), new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(apl.getString(R.string.cancel), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
                apl.finish();
